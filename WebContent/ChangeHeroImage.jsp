...
<!--==============================header=================================-->
	...
	"><img src="images/contact_us.png" height="70" width="300"></a>
		...
		<div class="content cont1"><div class="ic"></div>
			<div class="container_12">
				<div class="grid_12">
					<h2 class="mb0">Change Your Hero Image Here(Front Image)</h2>
				</div>
		...
		<div class="container_12">
				<div class="grid_8">
					<div class="blog">
						<img src="images/heromeans.jpg" alt="">
						<div class="extra_wrapper">
							<div class="text1">
							<br/>
							 <form name="" action="UploadHeroImage" enctype="multipart/form-data" method="post">
							 
							 Select Image You Want To Change
							 <select name="number"><option value="0">---select one---</option><option value="1">Change First Hero Image</option><option value="2">Change Second Hero Image</option><option value="3">Change third Hero Image</option></select>
							 <br/>
							 <br/>
							 Choose Your Image :<input type="file" name="image"><br/><br/><br/>
