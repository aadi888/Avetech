...
<!--==============================header=================================-->
	...
	"><img src="images/contact_us.png" height="70" width="300"></a>
		...
		<div class="content cont1"><div class="ic"></div>
			<div class="container_12">
				<div class="grid_12">
					<h2 class="mb0">Change Your News Here</h2>
				</div>
		...
		<div class="container_12">
				<div class="grid_8">
					<div class="blog">
						<img src="images/newsupdate.jpg" alt="">
						<div class="extra_wrapper">
							<div class="text1">
							<br/>
							 <form name="" action="UploadNewsController"  method="post">
							 
							 Select News You Want To Change
							 <select name="newsid"><option value="0">---select one---</option><option value="1">Change First News</option><option value="2">Change Second News</option><option value="3">Change third News</option><option value="4">Change fourth News</option><option value="5">Change fifth News</option></select><br/><br/>
							 <textarea rows="10" cols="40" name="news">Add Your News Here</textarea>
							 <br/>
							 <br/>
